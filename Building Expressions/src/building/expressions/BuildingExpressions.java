 ...
 */
package building.expressions;


/**
 *
 * @author oracion seis
 * the following program demonstrates the scenarios to consider when binding values or  properties
 */
...
// Area = width * height
final IntegerProperty width = new SimpleIntegerProperty(600);
final IntegerProperty height = new SimpleIntegerProperty(456);
